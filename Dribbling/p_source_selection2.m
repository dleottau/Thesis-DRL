...
if RL.param.softmax <= 0
    A_target(1) = e_greedy_selection(RL.Q, s, RL.param.epsilon, rnd.expl);
    A_target(2) = e_greedy_selection(RL.Q_y, s, RL.param.epsilon, rnd.expl);
    A_target(3) = e_greedy_selection(RL.Q_rot, s, RL.param.epsilon, rnd.expl);
end
